...
const CARDS: AboutStackCard[] = [
  {
    ...
    title: "A personal brand that projects professional authority.",
    description:
      "We translate complex careers—structural engineering, team leadership, and mentorship—into editorial portfolio websites that showcase real-world achievements.",
    testimonial: {
      quote: "Leon turned my professional history and project credentials into a clean, narrative-led brand that communicates trust instantly.",
      name: "Kossy Langat",
      role: "Structural Engineer & General Manager",
    },
    ...
    chips: [
      {
        ...
        detail: "Group engineering credentials, corporate leadership, and values into a single cohesive narrative.",
        metric: "Aligned public voice",
        toneClass: "about-3d-stack__chip--green",
      },
      {
        label: "Copy",
        title: "Editorial Storytelling",
        detail: "Explain complex civil projects and career milestones with professional restraint and clear proof.",
        metric: "High-trust narrative",
        toneClass: "about-3d-stack__chip--yellow",
      },
      {
        label: "Visual",
        title: "Editorial System",
        detail: "An image-led layout using structured grids and clean typography instead of generic profile blocks.",
        metric: "Visual clarity",
        toneClass: "about-3d-stack__chip--amber",
      },
      {
        label: "Values",
        title: "Values Positioning",
        detail: "Weave mentorship, representation, and professional integrity directly into the portfolio experience.",
        metric: "Genuine credibility",
  ...
  {
    number: "02",
    badge: "Operations Funnel",
    title: "Automating carrier intake and lead capture.",
    description:
      "We replace manual document chasing and phone tags with guided registration wizards, carrier intake forms, and secure document vaults.",
    testimonial: {
      quote: "The guided intake wizard qualified carrier prospects and captured DOT compliance files without manual paperwork.",
      name: "Faith",
      role: "Owner, Delivah",
    },
    ...
    chips: [
      {
        ...
        detail: "A multi-step registration flow that collects MC numbers, contact details, and filters equipment types.",
        metric: "Zero registration friction",
        toneClass: "about-3d-stack__chip--cream",
      },
      {
        label: "Upload",
        title: "Secure Compliance Upload",
        detail: "Allow carrier prospects to upload required operational documents directly and securely.",
        metric: "No manual paperwork",
        toneClass: "about-3d-stack__chip--orange-soft",
      },
      {
        label: "Admin",
        title: "Backend Lead Manager",
        detail: "A secure area for dispatch managers to review registration logs, verify files, and manage carrier leads.",
      ...
      },
      {
        ...
        detail: "Automated alerts sent directly to owners as soon as a new carrier completes intake.",
        metric: "Instant lead response",
  ...
  },
  {
    ...
    title: "Custom logistics software that automates dispatch.",
    description:
      "We build operations portals featuring dispatch admin dashboards, automated quote queues, real-time driver tracking, and customer tracking portals.",
    testimonial: {
      quote: "Leon built a custom dispatch engine that replaces phone tag and scattered records with guided digital workflows.",
      name: "Ken Madara",
      role: "Owner, Legit Logistics",
    },
    themeClass: "about-3d-stack__card--crimson",
    chips: [
      {
        label: "Admin",
        title: "Dispatch Control Panel",
        detail: "A central dashboard to review quotes, create delivery jobs, and monitor ongoing deliveries.",
        metric: "Unified admin control",
        toneClass: "about-3d-stack__chip--rose-light",
      },
      {
        label: "Driver",
        title: "Driver Mobile App",
        detail: "A mobile-first flow guiding drivers through milestones, capturing photo proof, and signatures.",
        metric: "Guided field actions",
        toneClass: "about-3d-stack__chip--rose-mid",
      },
      {
        label: "Track",
        title: "Customer Tracking Portal",
        detail: "A public portal that lets clients track deliveries in real time using a code or phone number.",
        metric: "Self-service tracking",
        toneClass: "about-3d-stack__chip--rose-strong",
      },
      {
        label: "DB",
        title: "Realtime Integration",
        detail: "Uses Supabase PostgreSQL, storage buckets, and row-level security for secure data handling.",
        metric: "Secure data streams",
